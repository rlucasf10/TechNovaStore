# Script PowerShell para iniciar servicios de desarrollo de forma escalonada
# Construye y levanta los contenedores en el orden correcto
# Usa docker-compose.optimized.yml (NODE_ENV=development)

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "TechnovaStore - Inicio Desarrollo" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
docker-compose -f docker-compose.optimized.yml up -d --build mongodb postgresql redis
...
docker-compose -f docker-compose.optimized.yml up -d --build api-gateway product-service order-service user-service payment-service notification-service ticket-service campaign-manager-service
...
docker-compose -f docker-compose.optimized.yml up -d --build sync-engine auto-purchase shipment-tracker
Write-Host "  Esperando 60 segundos..." -ForegroundColor Gray
Start-Sleep -Seconds 60
...
docker-compose -f docker-compose.optimized.yml up -d --build ollama chatbot recommender frontend
Write-Host "  Esperando 60 segundos..." -ForegroundColor Gray
Start-Sleep -Seconds 60
...
# COMENTADO: No es necesario para desarrollo de momento
# Write-Host "[7/7] FASE 5: Iniciando servicios de monitoreo..." -ForegroundColor Yellow
# docker-compose -f docker-compose.optimized.yml up -d --build prometheus grafana alertmanager
# Write-Host "  Esperando 30 segundos..." -ForegroundColor Gray
# Start-Sleep -Seconds 30
# docker-compose -f docker-compose.optimized.yml up -d --build elasticsearch logstash kibana
# Write-Host "  Esperando 30 segundos..." -ForegroundColor Gray
# Start-Sleep -Seconds 30
# docker-compose -f docker-compose.optimized.yml up -d --build mongodb-exporter postgres-exporter redis-exporter node-exporter
# Write-Host "  Esperando 30 segundos..." -ForegroundColor Gray
# Start-Sleep -Seconds 30
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "URLs de acceso (Desarrollo):" -ForegroundColor Cyan
