...
# Construir servicios en orden (por dominio)
$services = @(
    # Platform
    @{Step=1; Total=13; Name="API Gateway"; Path="domains/platform/api-gateway"},
    @{Step=2; Total=13; Name="Frontend"; Path="domains/platform/frontend"},
    # Catalog
    @{Step=3; Total=13; Name="Product Service"; Path="domains/catalog/product-service"},
    @{Step=4; Total=13; Name="Sync Engine"; Path="domains/catalog/sync-engine"},
    @{Step=5; Total=13; Name="Recommender Service"; Path="domains/catalog/recommender-service"},
    # Commerce
    @{Step=6; Total=13; Name="Order Service"; Path="domains/commerce/order-service"},
    @{Step=7; Total=13; Name="Payment Service"; Path="domains/commerce/payment-service"},
    @{Step=8; Total=13; Name="Auto Purchase Service"; Path="domains/commerce/auto-purchase-service"},
    # Customer
    @{Step=9; Total=13; Name="User Service"; Path="domains/customer/user-service"},
    @{Step=10; Total=13; Name="Notification Service"; Path="domains/customer/notification-service"},
    # Support
    @{Step=11; Total=13; Name="Ticket Service"; Path="domains/support/ticket-service"},
    @{Step=12; Total=13; Name="Chatbot Service"; Path="domains/support/chatbot-service"},
    @{Step=13; Total=13; Name="Shipment Tracker"; Path="domains/support/shipment-tracker"}
)
