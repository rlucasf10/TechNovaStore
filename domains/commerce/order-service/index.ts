/**
 * Entry Point del Servicio de Pedidos
 * 
 * Inicializa el servidor Express con la nueva arquitectura Screaming.
 */
...
// Metrics endpoint (sin autenticación)
...
// API Documentation (sin autenticación)
