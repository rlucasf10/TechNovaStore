/**
 * Middleware de Rate Limiting para payment-service
 * 
...
/**
 * Configuración del rate limiter para el payment-service
 * - 100 requests máximo por ventana de 15 minutos
 * - Excluye endpoints de health check y metrics
...
export const apiRateLimiter = rateLimit({
  ...
  // Función para saltar ciertos requests (health checks y metrics)
  skip: (req: Request) => {
    // Excluir health checks y metrics del rate limiting
