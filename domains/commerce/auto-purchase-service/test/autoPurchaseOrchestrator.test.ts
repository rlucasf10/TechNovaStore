import { AutoPurchaseOrchestrator, AutoPurchaseConfig, OrderForPurchase } from '../src/services/autoPurchaseOrchestrator';
import { waitForDatabaseOperations } from '../src/../../../../shared/infrastructure/utils/src/test/testHelpers';
    ...
    afterEach(async () => {
        ...
        if (activeResources.length > 0) {
            ...
            if (cleanupReport.errors.length > 0) {
                console.warn('Cleanup errors:', cleanupReport.errors.map((e: Error) => e.message));
            }
        }
    });
