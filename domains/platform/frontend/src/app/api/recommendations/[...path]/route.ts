/**
 * API Route: /api/recommendations/[...path]
 * 
 * Proxy catch-all para el servicio de recomendaciones
 * Maneja todas las rutas bajo /api/recommendations/*
 */
...
export async function POST(
  ...
  try {
    ...
    console.error('Error in /api/recommendations POST:', error);
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    );
