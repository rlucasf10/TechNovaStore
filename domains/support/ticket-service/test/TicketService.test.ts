...
import { SatisfactionService } from '../src/services/SatisfactionService';
import { Pool } from 'pg';
import { TicketCategory, TicketPriority, EscalationReason } from '../src/types';
  ...
  describe('EscalationService', () => {
    ...
    it('should detect complaint indicators', () => {
      const context = {
        ...
        conversationHistory: [
          {
            message: 'Estoy molesto con el servicio',
            timestamp: new Date(),
            sender: 'user' as const
          }
        ]
