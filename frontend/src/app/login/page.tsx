        ...
        <div className="max-w-md w-full space-y-8 animate-fade-in">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Inicia sesión en tu cuenta de TechNovaStore
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/recuperar-contrasena" className="text-sm font-medium text-primary-600 hover:text-primary-500 transition-colors">
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/registro" className="font-medium text-primary-600 hover:text-primary-500 transition-colors">
                Regístrate gratis
              </Link>
            </p>
          </div>
